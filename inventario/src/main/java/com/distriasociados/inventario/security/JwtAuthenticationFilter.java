...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            // Rechazar tokens que fueron invalidados en un logout explícito
            if (tokenBlacklistService.estaInvalidado(jwt)) {
                filterChain.doFilter(request, response);
                return;
            }

            final String cedula = jwtUtil.extractCedula(jwt);
            ...
            // Token inválido o expirado — no autenticamos, SecurityConfig devuelve 401
        }
